...
{
    protected SerializedProperty handleRange;
    protected SerializedProperty deadZone;
    protected SerializedProperty axisOptions;
    protected SerializedProperty snapX;
    protected SerializedProperty snapY;
    protected SerializedProperty background;
    protected SerializedProperty handle;
